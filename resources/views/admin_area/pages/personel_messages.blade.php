  ...
  <?php  if (!empty(session("message_send"))) {
    ?>
      ...
      Swal.fire({
        icon: "success",
        // title: "خطا",
        text: "<?php echo session("message_send"); ?>",
            ...
            <div class="card-body p-0">
              ...
              <div class="table-responsive mailbox-messages">
                ...
                <?php foreach($all_message as $message) { ?>
                  <?php $who_send = DB::table("personel")->where("id",$message->sender)->get(); ?>
                  <tr>
                    ...
                    <td class="mailbox-date"><a href="/admin area/message/replay message/<?php echo $message->id; ?>">پاسخ</a></td>
                  </tr>
                  <?php } ?>
                  <!-- <tr>
                    <td><input type="checkbox"></td>
