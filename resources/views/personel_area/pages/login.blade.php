...
<?php if (!empty(session("not_found"))) { ?>
  <script>
  Swal.fire({
    icon: "error",
  title: "خطا",
  text: "<?php echo session("not_found"); ?>",
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>ورود به پورتال داخلی</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="/personel/login" method="post">
        @csrf
        ...
        <!-- <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" name="submit" style="margin-right:100px;" class="btn btn-primary btn-block btn-flat">ورود</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
